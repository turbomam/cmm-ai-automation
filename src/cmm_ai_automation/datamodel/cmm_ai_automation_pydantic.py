...
linkml_meta = LinkMLMeta({'default_prefix': 'cmm',
     ...
     'prefixes': {'ATCC': {'prefix_prefix': 'ATCC',
                  ...
                  'mediadive.ingredient': {'prefix_prefix': 'mediadive.ingredient',
                                           'prefix_reference': 'https://mediadive.dsmz.de/ingredient/'},
                  'mediadive.medium': {'prefix_prefix': 'mediadive.medium',
                                       'prefix_reference': 'https://mediadive.dsmz.de/medium/'},
                  'mediadive.solution': {'prefix_prefix': 'mediadive.solution',
                                         'prefix_reference': 'https://mediadive.dsmz.de/solution/'},
...
class GrowthMedium(Mixture):
    ...
    has_solution_component: Optional[list[SolutionComponent]] = Field(default=[], description="""Solutions contained in this medium. Note: Not populated for MediaDive data due to complex nested structure (up to 5 levels deep, 42% of solutions reference other solutions). MediaDive composition uses has_ingredient_component with flattened ingredients from medium_compositions instead. See GitHub issue #111.""", json_schema_extra = { "linkml_meta": {'domain_of': ['GrowthMedium']} })
